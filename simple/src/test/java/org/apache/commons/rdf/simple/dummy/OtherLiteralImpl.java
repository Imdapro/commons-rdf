 ...
 */
public class OtherLiteralImpl implements Literal{
    ...
    public OtherLiteralImpl(final String literal) {
        this(literal, Types.XSD_STRING);
    }

    public OtherLiteralImpl(final String lexicalForm, final IRI dataType) {
    ...
    public OtherLiteralImpl(final String literal, final String languageTag) {
    ...
    public boolean equals(final Object obj) {
        ...
        return getDatatype().equals(literal.getDatatype()) && getLexicalForm().equals(literal.getLexicalForm())
                && getLanguageTag().equals(literal.getLanguageTag().map(OtherLiteralImpl::lowerCase));
    }
